                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="related" id="related" class="form-control" v-model="related" cols="30" rows="2"></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="resolution" id="resolution" class="form-control" v-model="resolution" cols="30" rows="5"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select v-model="customer_id" class="form-control" id="exampleFormControlSelect2" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select v-model="issuecategory_id" class="form-control" id="exampleFormControlSelect2" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select v-model="prority" class="form-control" id="exampleFormControlSelect2" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select v-model="status" class="form-control" id="exampleFormControlSelect2" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select v-model="user_id" class="form-control" id="exampleFormControlSelect2" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                               <!--  <input type="text" class="form-control" name="summary" id="summary" v-model="summary" /> -->
                                                <input type="text" name="summary" id="summary" class="form-control form-control-user" v-model="summary" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
