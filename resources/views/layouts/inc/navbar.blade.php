<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center">
        <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block">Help : 1252, 1252</li>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
                ...
                <img class="img-xs rounded-circle" src={{auth()->user()->image ? asset('storage/'. auth()->user()->image) : "../assets/images/faces/face8.jpg"}} alt="Profile image"> </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                    <img class="img-md rounded-circle" src={{auth()->user()->image ? asset('storage/'. auth()->user()->image) : "../assets/images/faces/face8.jpg"}} alt="Profile image">
                    <p class="mb-1 mt-3 font-weight-semibold">{{auth()->user()->username}}</p>
                    <p class="font-weight-light text-muted mb-0">{{auth()->user()->email}}</p>
                </div>
                <router-link to="/storage/profile" class="dropdown-item">My Profile</router-link>
